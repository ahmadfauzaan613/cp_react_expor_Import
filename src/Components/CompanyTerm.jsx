...
import shipping from '../Assets/aron-yigin-sNY6B9NsPP8-unsplash.jpg'
import payment from '../Assets/rupixen-com-Q59HmzK38eQ-unsplash.jpg'
import Lading from '../Assets/andy-li-CpsTAUPoScw-unsplash (1).jpg'
...
function CompanyTerm() {
  return (
    <div className="desktop3:mx-[10%] desktop3:mt-[3rem] desktop3:pb-3 phone:px-[5%]  tablet:px-[5%] laptop:px-[5%] desktop:px-[5%] desktop2:px-[5%] phone:mt-5 tablet:mt-5 laptop:mt-5">
      <p className="desktop3:text-[42px] desktop2:text-[36px] desktop:text-[30px] text-[#AA941E] phone:text-center phone:text-[30px] phone:pb-3 tablet:text-center tablet:text-[30px] tablet:pb-3 laptop:text-center laptop:text-[30px] laptop:pb-3">Company Terms</p>
